...
Encoder = tf.keras.models.Sequential([
  tf.keras.layers.Dense(4, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(l2)),
  tf.keras.layers.Dropout(0.1),
  tf.keras.layers.BatchNormalization(),
  tf.keras.layers.Dense(40, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(l2)),
  tf.keras.layers.Dropout(0.1),
  tf.keras.layers.BatchNormalization(),
  # tf.keras.layers.Dense(90, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(l2)),
  # tf.keras.layers.Dropout(0.1),
  # tf.keras.layers.BatchNormalization(),
  tf.keras.layers.Dense(70, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(l2)),
  tf.keras.layers.Dropout(0.1),
  tf.keras.layers.BatchNormalization(),
  tf.keras.layers.Dense(30, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(l2)),
  tf.keras.layers.Dropout(0.1),
  tf.keras.layers.BatchNormalization(),
  tf.keras.layers.Dense(15, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(l2)),
  tf.keras.layers.Dropout(0.1),
  tf.keras.layers.BatchNormalization(),
  tf.keras.layers.Dense(1, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(l2)),
])
...
Decoder = tf.keras.models.Sequential([
  ...
  tf.keras.layers.Dropout(0.1),
  tf.keras.layers.BatchNormalization(),
  tf.keras.layers.Dense(4, activation='sigmoid', kernel_regularizer=tf.keras.regularizers.l2(l2))
])
